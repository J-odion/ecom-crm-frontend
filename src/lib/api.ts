...
export const apiActions = {
  ...
  orders: {
    ...
    getActivity: (id: string) => api.get(`/orders/${id}/activity`),
    ...
    updateStatus: (id: string, status: string) => api.patch(`/orders/${id}/delivery-status`, { status }),
  },
  orderForms: {
    list: () => api.get("/order-forms"),
    get: (id: string) => api.get(`/order-forms/${id}`),
    create: (d: any) => api.post("/order-forms", d),
    update: (id: string, d: any) => api.patch(`/order-forms/${id}`, d),
    delete: (id: string) => api.delete(`/order-forms/${id}`),
    getIframe: (id: string) => `${API_BASE}/order-forms/${id}/embed`,
    getIframeCode: (id: string) => api.get(`/order-forms/${id}/iframe-code`),
    webhook: (d: any) => api.post("/order-forms/webhook", d),
  },
  inventory: {
  ...
  products: {
    ...
    addOffer: (id: string, d: any) => api.post(`/products/${id}/offers`, d),
    updateOffer: (id: string, offerId: string, d: any) => api.patch(`/products/${id}/offers/${offerId}`, d),
    deleteOffer: (id: string, offerId: string) => api.delete(`/products/${id}/offers/${offerId}`),
  },
  logistics: {
  ...
  analytics: {
    ...
    userStats: (id: string) => api.get(`/analytics/users/${id}`),
    performance: (params?: any) => api.get("/media-buyers/performance", { params }),
  },
  mediaBuyers: {
    logSpend: (d: { amount: number; platform: string; orderFormId?: string; notes?: string }) => api.post("/media-buyers/spend-log", d),
  ...
  accessControl: {
    ...
    createDepartment: (d: any) => api.post("/departments", d),
    updateDepartment: (id: string, d: any) => api.patch(`/departments/${id}`, d),
